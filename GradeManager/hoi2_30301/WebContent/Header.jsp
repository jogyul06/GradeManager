...
<h1 style="text-align: center;">학생 성적 조회 프로그램 ver 1.0</h1>
</header>
...
<footer style="position: absolute; bottom: 0; background: silver; width: 100%; padding: 15px 0;">
<h2 style="text-align: center;">Copyright @ 2023 All right</h2>
</footer>
</body>
</html>